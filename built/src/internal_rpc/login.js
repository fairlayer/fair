...
module.exports = function (p) { return __awaiter(_this, void 0, void 0, function () {
    var seed;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, derive(p.username, p.pw)];
            case 1:
                seed = _a.sent();
                return [4 /*yield*/, me.init(p.username, seed)];
            case 2:
                _a.sent();

...
module.exports = function (json, ws) { return __awaiter(_this, void 0, void 0, function () {
    var _a, start, limit, block_records;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                start = parseInt(json.start_block);
                ...
                return [4 /*yield*/, Block.findAll({
                        ...
                        where: {
                            id: (_a = {}, _a[Op.gt] = start, _a)
                        },
                        order: [['id', 'ASC']],
                        limit: limit
                    })];
            case 1:
                block_records = _b.sent();
                if (block_records[0] && block_records[0].id == start + 1) {
                    return [2 /*return*/, block_records.map(function (b, index) {

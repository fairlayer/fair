...
var rebroadcast = function (signed_batch) {
...
module.exports = function (opts) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            section('broadcast', function () { return __awaiter(_this, void 0, void 0, function () {
                var estimated;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (PK.pendingBatchHex) {
                                if (trace)
                                    l('Have pendingBatchHex, only 1 tx is supported');
                                return [2 /*return*/];
                            }
                            return [4 /*yield*/, me.batch_estimate(opts)];
                        case 1:
                            estimated = _a.sent();
                            if (!estimated)
                                return [2 /*return*/];

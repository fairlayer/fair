...
var Me = /** @class */ (function () {
    ...
    Me.prototype.init = function (username, seed) {
    ...
    Me.prototype.getAddress = function () {
        var encodable = [
    ...
    Me.prototype.batchAdd = function (method, args) {
        if (!me.record) {
    ...
    Me.prototype.batch_estimate = function (opts) {
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
    ...
    Me.prototype.startExternalRPC = function (advertized_url) {
        return __awaiter(this, void 0, void 0, function () {
            var port;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    Me.prototype.textMessage = function (they_pubkey, msg) {
    ...
    Me.prototype.send = function (m, json) {
        if (typeof m == 'string')
            m = fromHex(m);
